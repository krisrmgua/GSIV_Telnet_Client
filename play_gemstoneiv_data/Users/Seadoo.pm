# play_gemstoneiv_data::Users::Seadoo
package play_gemstoneiv_data::Users::Seadoo;
use Data::Dumper;
use strict;
...
%SCRIPTS = (
        ...
        'ubuff' => [ "prepare 602", "cast {pv1}", "sleep 5", "prepare 618", "cast {pv1}", "sleep 5", "prepare 602", "cast {pv1}", "sleep 5", "prepare 618", "cast {pv1}", "sleep 5", "prepare 602", "cast {pv1}", "sleep 5", "prepare 618", "cast {pv1}" ],
        ...
        'colors' => [ "prepare 611", "cast", "sleep 5", "prepare 611", "cast", "sleep 5", "prepare 611", "cast", "sleep 5", "prepare 611", "cast", "sleep 5" ],
    );
